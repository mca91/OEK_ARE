...
Functionals are often used as an alternative to loops. Not because loops are inherently slow (which is common wisdom), but because loops can be overly flexible:
...
- Others are likely to be puzzled by looking at your code if it uses a lot of for loops. Functionals immediately convey which iteration is done and which output is returned.
