...
```{r, eval = F, cache=T, message=F, warning=F}
library(pagerank) 
...
```{r, cache=T, eval = F, fig.align='center', echo=F, out.width='500px'}
...
Since the area of the unit circle is $\pi$ we use that $$\frac{1}{N}\sum_{i=1}^N \mathcal{I}_{\left\{x_i^2+y_i^2\leq1\right\}} \xrightarrow{p} \pi/4$$ for $x_i, y_i \overset{i.i.d.}{\sim} \mathcal{U}[0,1].$
