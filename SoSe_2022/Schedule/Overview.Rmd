...
- The final projects should be confined with the topics discussed in class but may go beyond that. Since this is a programming course, you should---regardless of the specific topic of your project---demonstrate proficiency in the main paradigms taught (tidy / OOP / FP / efficient programming), if applicable.

- You may work in groups of up to 3 students. We expect you to work collaboratively, preferably via Git. Final project code should be made available in private repositories (more on this later). You should specify contributions of each group member.
