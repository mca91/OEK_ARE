...
- circumvent web security measures
- you scrape personal information such as email addresses, etc. 
- you scrape a substantial amount of a websites content
...
- In the body tags are used to give the displayed information a structure. In our example we use: 
...
Websites are not only built with HTML. CSS is the language which is used to style a websites.
...
to now about classes, but ids work quite similar. 
