...
<ol start="1"> 
<li>  Experiment with `geom_point()` using the `mtcars` data set. Try out different aesthetics with different variables. What do you note?  </li>
</ol>
...
<li> Add for each number of cylinders a linear smoothing function to the plot. </li>
...
<ul>
    ...
    <li> compare the age distribution between the survivors and non-survivors.</li>
</ul>
