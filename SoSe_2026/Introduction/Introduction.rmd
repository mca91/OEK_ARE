...
2.[] = always returns object of same class -> we get a list
[[]] = can extract one element from a list or data frame
...
???
ifelse () is a vectorized function that is applied in each value of a vector while
