...
<li>  Which flights took the longest? Which traveled the shortest?</li>
<li>  Brainstorm as many ways as possible to select `dep_time`, `dep_delay`, `arr_time`, and `arr_delay`. </li>
<li>  Create a new variable `first_flight` which takes the value `TRUE` if it is the first flight of the day. </li>
</ol>
...
<li>  What was the most dangerous hour of the week according to the number of homicides (`OFFENSE_CODE_GROUP == "Homicide"`)?  </li>
<li>  Calculate for each district the proportion of motor vehicle accidents to all reported incidents (`OFFENSE_CODE_GROUP == "Motor Vehicle Accident Response"`).   </li>
