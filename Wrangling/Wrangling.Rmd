...
3. What was the most dangerous hour of the week according to the number of homicides (`OFFENSE_CODE_GROUP == "Homicide"`)?
4. Calculate for each district the proportion of motor vehicle accidents to all reported incidents (`OFFENSE_CODE_GROUP == "Motor Vehicle Accident Response"`). 
